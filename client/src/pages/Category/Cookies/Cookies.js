...
import cookiesList from '../../../common/image/CookiesList.webp';
import {
    ContentList,
    ContentBox,
    ContentTit,
...
const Snacks = () => {
    ...
    useEffect(() => {
        axios
          .get(`${URI}/products/category/Cookies/?page=${listCurrentPage}&pageSize=${PER_PAGE}`)
          .then(res => {
            console.log(res);
...
return (
    <>
      <BackgroundImageContainer backgroundImage={`url(${cookiesList})`}>
        COOKIES
      </BackgroundImageContainer>
      <Gnb />
