...
import snacksList from '../../../common/image/SnacksList.webp';
import {
    ContentList,
    ContentBox,
    ContentTit,
...
const Snacks = () => {
    ...
    useEffect(() => {
        axios
          .get(`${URI}/products/category/Snacks/?page=${listCurrentPage}&pageSize=${PER_PAGE}`)
          .then(res => {
            console.log(res);
...
return (
    <>
      <BackgroundImageContainer backgroundImage={`url(${snacksList})`}>
        SNACKS
      </BackgroundImageContainer>
      <Gnb />
