...
- **팀원 :** 김동윤(팀장), 윤건용(부팀장), 유주성, 박영길, 홍윤표, 손영진, 김민수
...
|-상품등록</br>-상품수정</br>-상품조회</br>-상품삭제</br>-상품검색</br>-카테고리별조회</br>-아이템조회</br>-좋아요</br>-리뷰쓰기</br>-리뷰조회</br>-카트에담기|-로그인</br>-회원가입</br>-마이페이지</br>-클라이언트 도메인 설정|-헤더</br>-푸터</br>-장바구니</br>-주문</br>-결제|-게시글 리스트 조회(페이지네이션)</br>-게시글검색</br>게시글필터</br>-게시글 생성(다수의 이미지 첨부기능)</br>-게시글 수정</br>-게시글 삭제</br>-댓글 생성</br>-댓글 수정</br>-댓글 조회</br>-댓글 삭제|-EC2 배포환경 구축</br>-Docker컨테이너 배포</br>-게시글 리스트 조회(페이지네이션)</br>-게시글 생성(다수의 이미지 첨부기능)</br>-게시글 수정</br>-게시글 삭제</br>-댓글 생성</br>-댓글 수정</br>-댓글 조회</br>-댓글 삭제</br>-마이페이지 회원정보 변경기능</br>-마이페이지 프로필 사진등록 기능|-DB(MYSQL)환경 AMAZON RDS 구축</br>-회원가입</br>-로그인 인가 인증(JWT)</br>-Google OAuth2|-ACM및 NGINX 인증(https)</br>-상품 등록</br>-상품 수정</br>-상품 조회</br>-상품 삭제</br>-상품 리스트별 조회</br>(페이지네이션)</br>-상품 좋아요 기능</br>-장바구니 등록</br>-장바구니 수정</br>-장바구니 조회</br>-장바구니 삭제</br>-주문 기능 구현(DB이슈)</br>-주문 조회(DB 이슈)</br>|
